    ...
    <div class="rightsidebar_box rt">
        ...
        <div class="rs_content">
            ...
            <div class="save_password">
                <a href="#" onclick="btnUpdatePassword()" style="color:#fff">保存更改</a>
            </div>
        </div>
    </div>
</div>
...
function btnUpdatePassword(){
	...
	if(checkPasswordLength(oldVal)&&
			...
			checkPasswordLength(confirmVal)&&
			checkPasswordEquals()){
...
$("#confirmPassword").blur(function(){
	//获取确认新密码框的值，函数返回true，表示输入的密码格式正确
	if(checkPasswordLength($("#confirmPassword").val())){
		...
		if(checkPasswordEquals()){
			...
			$("#confirmPasswordSpan").html("确认密码和新密码不相同");
			$("#confirmPasswordSpan").css("color","red");
		}
	}else{
		$("#confirmPasswordSpan").html("密码格式错误");
		$("#confirmPasswordSpan").css("color","red");
	}
});
