...
<!--细节导航-->
<div id="nav_detail">
    <h5>首页 > 学习用品 > 笔记本电脑 > ${product.title }></h5>
</div>
<!--产品预览-->
<div id="shop_detail">
    <!-- 左侧-->
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" style="width:450px;height:350px" src="..${product.image }"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        <!-- 商品名称-->
        <h1>${product.itemType }</h1>
        <!-- 商品全称-->
        <h3>${product.title }</h3>
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>学员售价：</b><span>￥${product.price }</span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function (e) {
		$.ajax({
			...
			//success表示状态码为200，其它不成功的代码都可以用error表示
			//ajax异步请求发生重定向的时候，需要配置失败回调函数
			"error":function(obj){
